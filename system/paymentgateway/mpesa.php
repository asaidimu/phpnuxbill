...
function mpesa_save_config()
{
    ...
    $params = [
        ...
        "code" => $mpesa["MPESA_SHORTCODE"],
        "confirmation" => $mpesa["MPESA_CALLBACK_URL"],
        "validation" => $mpesa["MPESA_VALIDATION_URL"],
        "key" => $mpesa["MPESA_CONSUMER_KEY"],
        "secret" => $mpesa["MPESA_CONSUMER_SECRET"],
    ];

    $c2b = new C2b();
    $response = $c2b->register($params);
