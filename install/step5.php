    ...
    <div id='main-container'>
        ...
        <div class="span12">
            ...
            <p>
                ...
                You have just install ZeiteckIspRadius !<br><br>
                <span class="text-danger">But wait!!<br>
                    <ol>
                        ...
                        <li>Activate <a href="https://zeiteckispradius.zeiteckcomputers.co.ke/wiki/Cron-Jobs" target="_blank">Cronjob</a> for Expired and Reminder.</li>
                        <li>Check <a href="https://zeiteckispradius.zeiteckcomputers.co.ke/wiki/How-It-Works---Cara-kerja" target="_blank">how ZeiteckIspRadius Works</a></li>
                        <li><a href="https://zeiteckispradius.zeiteckcomputers.co.ke/wiki#login-page-mikrotik" target="_blank">how to link Mikrotik Login to ZeiteckIspRadius</a></li>
                        <li>or use <a href="https://zeiteckispradius.zeiteckcomputers.co.ke-mikrotik-login-template" target="_blank">Mikrotik Login Template for ZeiteckIspRadius</a></li>
                    </ol>
                </span><br><br>
