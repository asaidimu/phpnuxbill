...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_669e3855d9e9f4_32367507',
...
function content_669e3855d9e9f4_32367507 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php echo '<script'; ?>
 src="https://cdn.datatables.net/buttons/1.7.1/js/dataTables.buttons.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
...
>
<?php echo '<script'; ?>
 src="https://cdn.datatables.net/1.11.3/js/dataTables.bootstrap5.min.js"><?php echo '</script'; ?>
>
...
plugin/pppoe_monitor_router_menu">
...
plugin/pppoe_monitor_router_menu/<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
...
plugin/pppoe_monitor_router_get_combined_users/<?php echo $_smarty_tpl->tpl_vars['router']->value;?>
',
            dataSrc: ''
        }
    });
    ...
    $j.ajax({
        url: '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
plugin/pppoe_monitor_router_get_combined_users',
        method: 'GET',
        dataType: 'json',
...
function reconnect(id, username) {
    if (confirm('Are you sure you want to disconnect user ' + username + '?')) {
        $.ajax({
            url: '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
plugin/pppoe_monitor_router_delete_ppp_user/<?php echo $_smarty_tpl->tpl_vars['router']->value;?>
', // Perbaiki URL AJAX
            method: 'POST',
...
function generateDailyData(username, startDate, endDate) {
    return new Promise((resolve, reject) => {
        $j.ajax({
            url: '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
plugin/pppoe_monitor_router_daily_data_usage/<?php echo $_smarty_tpl->tpl_vars['router']->value;?>
',
            data: {
                username: username,
...
function updateTrafficValues() {
    ...
    $j.ajax({
        url: '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
plugin/pppoe_monitor_router_traffic/<?php echo $_smarty_tpl->tpl_vars['router']->value;?>
',
        dataType: 'json',
